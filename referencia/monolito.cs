// ARCHIVO DE REFERENCIA — No forma parte del proyecto compilable
// Contiene el modelo completo de datos y datos de demo para guiar
// la construcción de entidades y scripts SQL.
